...
link: "http://wagnerbeethoven.medium.com/agilidade-%C3%A9-sobre-fazer-r%C3%A1pido-como-utilizar-agile-ux-e-desenvolver-melhores-produtos-2ed9e9b4f1fa"
date: "2021-08-18"
...
**Pesquisa sobre Agilidade, Lean e Agile UX para o 1º Procenge Agile Week.**

O material escrito abaixo foi elaborado por mim baseado em uma pesquisa de aprofundamento da apresentação no Procenge Agile Week. Também colaboraram [Pedro Pereira](https://www.linkedin.com/in/pedropereiraa/), [Lídia Cavalcante](https://www.linkedin.com/in/lidiacavalcante/) e [Fernando Fernandes](https://www.linkedin.com/in/feof87/).
...
![Seta feitas em 3 etapas: 1. Entendimento do problema, 2. Desenvolvimento da aplicação, 3. coleta de feedback. A seta aponta para o item ‘Versão do aplicativo’. Englobando tudo isso, Desenvolvimento da aplicação e a atuação do Designer](https://miro.medium.com/max/770/1*9RJny-FIPxm3K4fi52IuVA.jpeg "Representação gráfica da atuação do Designer do desenvolvimento da solução")
...
1. Elaboração dos entregáveis de design;
1. Codificação desses entregáveis;
1. Testes com o intuito de garantir que os requisitos foram desenvolvidos com sucesso;
1. Implantação/Integração da funcionalidade no ambiente de produção;
1. Revisão/Retrospectiva dos acontecimentos para aprender com os erros e melhorar a assertividade nos ciclos futuros.

![Representação de 3 ciclos ágeis](https://miro.medium.com/max/770/1*kNGlngqw4AeCiemTYPKt4g.jpeg "Representação de 3 ciclos ágeis")
...
![Representação gráfica da participação do Design Thinking, Agile UX e Lean UX](https://miro.medium.com/max/770/1*44_323dVwyr9PAtMoS3U0Q.jpeg "Representação gráfica da atuação do Designer do desenvolvimento da solução")
...
* [A diferença entre Lean UX e Agile UX (e a importância dos protótipos no design](https://brasil.uxdesign.cc/a-diferen%25C3%25A7a-entre-lean-ux-e-agile-ux-e-a-import%25C3%25A2ncia-dos-prot%25C3%25B3tipos-no-design-85607e43a882) e [Lean UX: método de trabalho ágil para User Experience Design](https://brasil.uxdesign.cc/lean-ux-m%25C3%25A9todo-de-trabalho-%25C3%25A1gil-para-user-experience-design-cc494059f4f8), Fabrício Teixeira

...
A turma tinha vivência e _know-how_ gigantesco sobre Justiça Brasileira, processamento de dados e desenvolvimento de software.
...
<iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fcnj.oficial%2Fposts%2Fpfbid02dWpRy3EyRZShDG5P6DdajKzzZK6Q7roQmMqeRK86Z6JLzmCBiuMjNoPyuwMsjcuDl&show_text=false&width=500" width="500" height="498" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
**Release**
...
* Analista de processos de negócios: [Diego Lages][4] e [Renato Cirne](https://www.linkedin.com/in/renato-cirne-31867b1b8/).
...
[Slide de apresentação do Pitch 1.01 MB](https://bitbucket.org/wagnerbeethoven/2021-02-13-hackathon-cnj-inova/raw/cb96872ad9e128040499f910d1e8a8247f8ff533/cnj-inova-demoday-apresentacao.pdf)
...
<iframe src="https://www.youtube.com/embed/3GfGHxTlJRE" title="CNJ Inova Demoday: Pitch da equipe Panorama" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
![Texto “Parorama” escrito em cima, ao fundo da letra última letra “A” um círculo amarelo que é ligado ao outro círculo azul e este ligado a mais outros círculos, um vermelho e outro verde.](https://miro.medium.com/max/770/1*KEp94hlYJd4X5xHQIKVDKA.jpeg "Logo Panorama")
...
![1 — Distribuição; 2 — Conclusão; 3 — Liminar; 4 — Despacho; 5 — Citação; 6 — Audiência; 7 — Decisão; 8 — Julgamento; 9 — Trânsito em Julgado; 10 — Arquivamento;]( https://miro.medium.com/max/770/1*ggCckckAbaHH6d97s_N_ZA.jpeg)
...
![1 — Simplicidade; 2 — Objetividade; 3 — Rapidez; 4 — Qualidade; 5 — Foco no problema; 6 — Encontrar soluções; 7 — Associados as Boas Práticas do CNJ; 8 — Interatividade; 9 — Avisos e Alertas de situações em crise; 10 — Sugere melhorias baseadas em inteligência artificial;](https://miro.medium.com/max/770/1*eWmCdDnkNt55Oc5FqiuLJw.png)

# Funcionalidades principais

![Grupo de UJs simulares; Alertas de movimentos anormais; Ranking de UJs; Notificações de UJ; Compartilhamento de boas práticas; Suporte a decisões;](https://miro.medium.com/max/770/1*jT9BElaPM23yIP8Y3wD4tQ.png)

# As tecnologias utilizadas

![HTML 5, CSS 3, Ecmascript 5, Python, Bootstrap, Node, Sass, Docker, Heroku](https://miro.medium.com/max/770/1*_wCIyep1tCp50Jm-SHglVg.png)
...
* 📎 [Versão preliminar construída por Diogo 2.42 MB](https://www.bitbucket.org/wagnerbeethoven/2021-02-13-hackathon-cnj-inova/raw/1e60349a3c9f150a5001787dadb9055aee14b5d1/0-cnj-inova-wireframe-diego.pdf)
* 📎[Versão “Zero” refeita 1.11 MB](https://www.bitbucket.org/wagnerbeethoven/2021-02-13-hackathon-cnj-inova/raw/e38a0f6a5243ed970126ea47e3d2161285050907/hackathon/1-cnj-inova-wireframe-diego.pdf)
...
![Página inicial da Panorama da fase 1 do Hackathon](https://miro.medium.com/max/770/0*T86aNc9G5_-_h3-r.png "Página inicial da Panorama da fase 1 do Hackathon")

![Página de detalhes da Panorama da fase 1 do Hackathon](https://miro.medium.com/max/770/0*lvflVLaN3CQXhMZ4.png "Página de detalhes da Panorama da fase 1 do Hackathon")
...
![Tela inicial](https://miro.medium.com/max/770/0*SH3EUblDDFkuF0D8.png "Tela inicial")
...
12. 12.Lista dos melhores tempos das UJs do mesmo tipo;
...
![Página inicial](https://miro.medium.com/max/770/0*IMRQqFmTxQYU7mLT.png "Página inicial")
![Tela de detalhes — Destaques](https://miro.medium.com/max/770/0*eRlJEe-2KvYQ0B6j.png "Tela de detalhes — Destaques")
![Tela de detalhes — Gargalos](https://miro.medium.com/max/770/0*uqJjDunJnT20LL7b.png "Tela de detalhes — Gargalos")
...
1. **O que acontece se quisermos carregar todos os dados na solução Nossa solução está preparada?**  
   _Limitamos o que foi carregado no banco de dados para fins demonstrativos, porém a solução foi arquitetada para receber todos os dados._
...
* Aplicação final: [https://panorama-fase2.herokuapp.com/index.html](https://panorama-fase2.herokuapp.com/index.html)
...
**Aviso!**: Alguns trechos do material apresentando aqui foram extraídos da comunicação oficial do CNJ e do repositório no GitHub do projeto.